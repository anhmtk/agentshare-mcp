# MCP Discord — showcase posts

Official MCP community Discord. Post **once** in an appropriate channel (`#showcase`, `#self-promo`, or `#general` if allowed — read **#rules** first).
...
```text
Use AgentShare MCP: commerce_quote mode=best_offer, query="Raspberry Pi 5 8GB", max_price_usd=120, currency=USD
```
